...
if (isset($_GET['delete'])) {
    ...
    unlink("uploads/" . $rowModulDetails['file']); //menghapus file dari folder uploads
                ...
                <?php if (isset($_GET['detail'])): ?>
                    ...
                    <table class="table table-stripped">
                        ...
                        <tr>
                            <th>Instructor</th>
                            <th>:</th>
                            <th><?PHP echo $rowModul['instructor_name'] ?></th>
                        </tr>
                    </table>
                    <br>
                    <br>
                        ...
                        <tbody>
                            <?php foreach ($rowDetailModuls as $index => $rowDetailModul): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank" href="?page=tambah-modul&download=<?php echo urldecode($rowDetailModul['file']) ?>">
...
<script>
    // var, let, const, var: ketika nilainya tidak ada tidak eror, kalo let harus mempunyai nilai
