...
$queryMainMenu = mysqli_query(
    ...
    JOIN menus_roles ON menus.id = menus_roles.id_menu 
    JOIN roles ON roles.id = menus_roles.id_roles
     WHERE menus_roles.id_roles = '$id_roles' AND 
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <?php foreach ($rowMainMenu as $mainMenu): ?>
            ...
            $querySubMenu = mysqli_query(
                ...
                JOIN menus_roles ON menus.id = menus_roles.id_menu 
                 JOIN roles ON roles.id = menus_roles.id_roles
                WHERE  menus_roles.id_roles = '$id_roles' AND parent_id ='$id_menu' ORDER BY urutan ASC"
            );
            ?>
